...
public class PathTile {
    ...
    public static final Color COLOR_FRONTIER = new Color(246, 255, 102); // RGB code for yellow
    public static final Color COLOR_TRAVERSED = new Color(193, 228, 255); //RGB code for light blue
