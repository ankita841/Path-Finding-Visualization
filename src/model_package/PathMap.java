...
public class PathMap extends Observable{
     ...
     */
    public PathTile getTile(Point point)
    {
        return this.tileMap[point.x][point.y];
    }
    ...
    public void manualNotify()
    {
        ...
        this.notifyObservers();  //notify all of its observers if the object has changed. It will trigger a notification
    }
